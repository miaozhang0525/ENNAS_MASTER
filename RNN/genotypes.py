...
ENNAS=Genotype(recurrent=[('sigmoid', 0), ('identity', 1), ('tanh', 1), ('sigmoid', 3), ('identity', 0), ('tanh', 0), ('sigmoid', 4), ('sigmoid', 3)], concat=range(1, 9))
ENNAS_PR=Genotype(recurrent=[('tanh', 0), ('sigmoid', 0), ('sigmoid', 2), ('sigmoid', 3), ('tanh', 4), ('identity', 2), ('identity', 3), ('sigmoid', 3)], concat=range(1, 9))
