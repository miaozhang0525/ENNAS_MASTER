...
parser.add_argument('--data', type=str, default='/home/mzhang3/Data/DARTS/darts-master/data/penn',
...
parser.add_argument('--arch', type=str, default='NSEA21', help='which architecture to use')
...
def train():
    ...
    while i < train_data.size(0) - 1 - 1:
        ...
        if np.isnan(total_loss.cpu().data):
          raise
